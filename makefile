...
update-license-header push-to-vcs reset-and-push-to-vcs
...
reset-and-push-to-vcs: purge
	@rm -rf $(MAKEFILE_PATH)/.git/
	@git init
	@git remote add github git@github.com:yingzhuo/java-gradle-app-skeleton.git
	@$(GRADLEW) 'pushToVcs'
